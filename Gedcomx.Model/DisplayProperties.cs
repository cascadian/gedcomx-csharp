...
namespace Gx.Conclusion
{
    ...
    public partial class DisplayProperties : Gx.Common.ExtensibleData
    {
        ...
        private List<FamilyView> _familiesAsParent;
        private List<FamilyView> _familiesAsChild;
        /// <summary>
        ...
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "familiesAsParent", Namespace = "http://gedcomx.org/v1/")]
        [Newtonsoft.Json.JsonProperty("familiesAsParent")]
        public List<FamilyView> FamiliesAsParent
        {
            get
            {
                return _familiesAsParent;
            }

            set
            {
                _familiesAsParent = value;
            }
        }

        [System.Xml.Serialization.XmlElementAttribute(ElementName = "familiesAsChild", Namespace = "http://gedcomx.org/v1/")]
        [Newtonsoft.Json.JsonProperty("familiesAsChild")]
        public List<FamilyView> FamiliesAsChild
        {
            get
            {
                return _familiesAsChild;
            }

            set
            {
                _familiesAsChild = value;
            }
        }
